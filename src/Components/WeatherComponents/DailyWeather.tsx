    ...
    return(
        <div className="p-10 justify-around text-[#e8e8e8]  items-center flex flex-row w-full">
            {days?.slice(0,4).map((data: any)=>(
                <div className="w-44 p-5 h-80 bg=[#1b1b1d] hover:duration-500 hover:shadow-stone-400 duration-700  shadow-2xl flex flex-col justify-center items-center rounded-3xl">
